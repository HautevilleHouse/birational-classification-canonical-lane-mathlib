# Birational Classification — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/birational-classification-canonical-lane-mathlib.git
cd birational-classification-canonical-lane-mathlib
lake exe
lake build
```
